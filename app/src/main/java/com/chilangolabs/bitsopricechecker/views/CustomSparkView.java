...
/**
 * Fork by Gorro on 08/05/17.
 */

public class CustomSparkView extends View implements ScrubGestureDetector.ScrubListener {
    ...
    public void onScrubbed(float x, float y) {
        ...
        if (scrubListener != null) {
            ...
            if (scrubListener != null) {
                scrubListener.onScrubbed(adapter.getItem(index), index);
            }
        }
    ...
    public void onScrubEnded() {
        scrubLinePath.reset();
        if (scrubListener != null) scrubListener.onScrubbed(null, 0);
        invalidate();
    }
    ...
    public interface OnScrubListener {
         ...
         */
        void onScrubbed(Object value, int position);
    }
